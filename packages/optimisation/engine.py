...
def optimise_portfolio(asset_actions:list[dict],capital_budget_m=500,max_projects=20,max_development_share=.45,cvar_penalty=.3,minimum_liquidity_m=50):
 result=optimise_multi_period(asset_actions,horizon_years=5,total_capital_budget_m=capital_budget_m,minimum_liquidity_m=minimum_liquidity_m,max_concurrent_projects=max_projects,max_development_share=max_development_share,cvar_penalty=cvar_penalty)
